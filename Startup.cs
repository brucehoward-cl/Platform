...
namespace Platform
{
    public class Startup
    {
        ...
        {
            services.Configure<CookiePolicyOptions>(opts => { opts.CheckConsentNeeded = context => true; }); //for client cookies

            services.AddDistributedMemoryCache();  //for session cookies
            services.AddSession(options => {        //for session cookies
